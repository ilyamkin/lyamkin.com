    ...
    >
      ...
      <ul className="social-list">
        <li className="social-item">
          <a className="social-link" href="https://twitter.com/ilyamkin" aria-label="Visit my Twitter" target="_blank" rel="noopener noreferrer">
        ...
        <li className="social-item">
          <a className="social-link" href="https://github.com/ilyamkin" aria-label="Visit my Github" target="_blank" rel="noopener noreferrer">
        ...
        <li className="social-item">
          <a className="social-link" href="https://www.linkedin.com/in/ilyalyamkin/" aria-label="Visit my Linkedin" target="_blank" rel="noopener noreferrer">
        ...
        <li className="social-item">
          <a className="social-link" href="https://t.me/ilyamkin" aria-label="Visit my Telegram" target="_blank" rel="noopener noreferrer">
