    ...
    >
      ...
      <ul className="social-list">
        <li className="social-item">
          <a className="social-link" href="https://twitter.com/ilyamkin" aria-label="Visit my Twitter" target="_blank" rel="noopener noreferrer me">
        ...
        <li className="social-item">
          <a className="social-link" href="https://github.com/ilyamkin" aria-label="Visit my Github" target="_blank" rel="noopener noreferrer me">
        ...
        <li className="social-item">
          <a className="social-link" href="https://www.linkedin.com/in/ilyalyamkin/" aria-label="Visit my Linkedin" target="_blank" rel="noopener noreferrer me">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24"><title>LinkedIn icon</title><path fill="currentColor" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
          </a>
        </li>
        <li className="social-item">
          <a className="social-link" href="https://t.me/ilyamkin" aria-label="Visit my Telegram" target="_blank" rel="noopener noreferrer me">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24"><title>Telegram icon</title><path fill="currentColor" d="M23.91 3.79L20.3 20.84c-.25 1.21-.98 1.5-2 .94l-5.5-4.07-2.66 2.57c-.3.3-.55.56-1.1.56-.72 0-.6-.27-.84-.95L6.3 13.7l-5.45-1.7c-1.18-.35-1.19-1.16.26-1.75l21.26-8.2c.97-.43 1.9.24 1.53 1.73z"/></svg>
          </a>
        </li>
      </ul>
    </div>
